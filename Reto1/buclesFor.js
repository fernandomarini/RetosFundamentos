...
function add(myWords) {
    ...
    ;
    console.log("La suma de carcteres de las palabras del array es: ".concat(suma, " y fue calculada con un For Tradicional"));
}
;
// CON FOR OF
function add2(myWords) {
    ...
    ;
    console.log("La suma de carcteres de las palabras del array es: ".concat(suma, " y fue calculada con un For Of"));
}
;
add(arrMyWords);
add2(arrMyWords);
